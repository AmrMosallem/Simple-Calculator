...
function App() {
  ...
  const btnTxt = [
    { text: "C", value: "C", className: "col-span-2 bg-blue-600" },
    { text: "/", value: "/", className: "bg-blue-600" },
    { text: "*", value: "*", className: "bg-blue-600" },
    { text: "7", value: "7" },
    { text: "8", value: "8" },
    { text: "9", value: "9" },
  ...
  return (
    <>
      ...
      {/* Footer */}
      <footer className="footer font-['Tangerine'] mt-4 text-center text-white text-lg">
        <p>
